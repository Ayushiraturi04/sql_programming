...
INSERT INTO employee_payroll VALUES
    (1, 'Ayushi', 0.0, '2000-01-01'),
    (2, 'Chehak', 1.0, '2001-10-01'),
    (3, 'Avanti ', 1.0, '2004-09-10');
...
-- +--+------+------+----------+
-- |1 |Ayushi |0     |2000-01-01|
-- |2 |Chehak |1     |2001-10-01|
-- |3 |Avanti |1     |2004-09-10|
-- +--+------+------+----------+
...
SELECT salary FROM employee_payroll WHERE name='Darpan';
-- +------+
-- |salary|
-- +------+
-- |0     |
...
-- +--+------+------+----------+------+
-- |1 |Ayushi |0     |2000-01-01|M     |
-- |2 |Chehak |1     |2001-10-01|M     |
-- +--+------+------+----------+------+
